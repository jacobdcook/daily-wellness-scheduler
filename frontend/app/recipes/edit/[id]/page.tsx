...
import { getRecipe, updateRecipe, calculateRecipeNutrition, Ingredient, RecipeNutrition } from "@/utils/api";
...
export default function EditRecipePage() {
    ...
    const loadRecipe = async () => {
        ...
        try {
            ...
            // Note: Backend should handle this, but we can check here too
            setName(recipe.name);
            ...
            // Convert ingredients to format with id
            ...
            setNutrition(recipe.nutrition as RecipeNutrition);
        } catch (error: any) {
            console.error("Failed to load recipe:", error);
            showToast(error.message || "Failed to load recipe", "error");
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 pb-20">
            <div className="max-w-4xl mx-auto px-4 py-6">
                ...
                {/* Same form as create page - I'll reuse the structure */}
                ...
                <div className="space-y-6">
                    ...
                    {/* Nutrition Preview - Same as create page */}
                    {nutrition && (
                        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-orange-500/20">
                    ...
                    {/* Instructions - Same as create page */}
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-orange-500/20">
                        <div className="flex items-center justify-between mb-4">
